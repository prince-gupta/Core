...
public class Way2sms {
   // private URLConnection sendSMSConnection;
    ...
    public String loginWay2SMS(String userName,String password)
    {
        ...
        try {
         ...
         //   urlLogin=new URL("http://site5.way2sms.com/Login1.action");
            ...
            loginConnection.setRequestProperty("Referer", "http://site24.way2sms.com//entry.jsp");
    ...
    {  
        final String USERNAME="9718042666";//REQUIRED
        final String PASSWORD="P6225A";//REQUIRED
     ...
     /*   if(args.length>0)
        ...
        { */
        	String msg2="Hello There"; //msg to be sent
            phoneNumber.append("8130768666"); /*want to use as bean ??? pass the parametrs for phone,message to send multiple number just insert ';' between them and pass as  a string */
            phoneNumber.append(';');
